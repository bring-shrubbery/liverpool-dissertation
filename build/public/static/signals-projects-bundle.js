...
function (_Component) {
  ...
  function ProjectManagerView(props) {
    ...
    _this.renderProjects = _this.renderProjects.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.fetchProjectsInfo = _this.fetchProjectsInfo.bind(_assertThisInitialized(_assertThisInitialized(_this)));
...
function (_Component2) {
  ...
  function NewProject(props) {
    ...
    _this2.submitNewProject = _this2.submitNewProject.bind(_assertThisInitialized(_assertThisInitialized(_this2)));
    _this2.moveToFilling = _this2.moveToFilling.bind(_assertThisInitialized(_assertThisInitialized(_this2)));
    _this2.cancelFill = _this2.cancelFill.bind(_assertThisInitialized(_assertThisInitialized(_this2)));
    return _this2;
  }
